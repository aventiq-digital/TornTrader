...
(function () {
  ...
  function refreshTornInventoryBasis(root = document) {
    ...
    for (const container of containers) {
      ...
      ensureInventorySortControl(container); applyInventoryBlockOrder(container, sortRecords, scan);
    }
