...
(function () {
  ...
  function refreshTornInventoryBasis(root = document) {
    ...
    for (const container of containers) {
      ...
      ensureInventorySortControl(container); queueInventoryStableSort(container, sortRecords, scan, { immediate: state.inventorySortImmediate });
    }
