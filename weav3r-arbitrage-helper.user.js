...
(function () {
  ...
  const TORN_INVENTORY_WAH_SELECTOR = '[data-wah-item-history],[data-wah-item-basis],[data-wah-weav3r-links],[data-wah-item-bazaar],[data-wah-item-trader],[data-wah-item-best-sale],[data-wah-item-profit],[data-wah-bazaar-sell-quantity]';
  ...
  function renderInventoryBazaarSellQuantity(record) {
    ...
    if (!state.inventoryBazaarSellFilter) { node?.remove(); return null; } if (!node) { node = document.createElement('span'); node.className = 'wah-item-sell-quantity'; node.dataset.wahBazaarSellQuantity = ''; host.appendChild(node); }
    node.textContent = `Bazaar-Verkauf: ${record.sellDecision.sellableQuantity}/${record.sellDecision.inventoryQuantity}`; return node;
  }
